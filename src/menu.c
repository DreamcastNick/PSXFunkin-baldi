...
static const char *funny_messages[][2] = {
	...
	{"FUNKIN", "FOREVER"},
	{"WHAT THE HELL", "BALDI PSX"},
	{"LIKE LAMMY", "BUT COOLER"},
	{"NO JUMPSCARES", "SORRY"},
	{"NO NOTE TYPES", "SORRY"},
	{"NO PIRACY SCREEN", "SORRY"},
	{"DCNICK", "SETTING STANDARDS"},
	{"BIRTHDAY BASH IS", "DOG WATER"},
	{"PSXDEV", "HOMEBREW"},
...
void Menu_Load(MenuPage page)
{
	...
	menu.gf = Char_GF_New(FIXED_DEC(128,1), FIXED_DEC(-12,1));
			...
			else
			{
				...
				//Fallthrough
					...
					case 1:
						...
						menu.font_bold.draw(&menu.font_bold, "ADVIDEGEP", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 16, FontAlign_Center);
						break;
				...
				//Fallthrough
					case 13:
						menu.font_bold.draw(&menu.font_bold, "BALDI", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 24, FontAlign_Center);
						break;
				}
				break;
			}
	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{"1", StageId_1_1, "BACK TO SCHOOL", {"BASICS", "LESSON", "DISSMISSAL"}},
			};
		...
		case MenuPage_Mods:
		{
			static const struct
			{
				...
				{StageId_Kapi_2, "   BALDI FUNKIN PSX PORT", false},				
				...
				{StageId_Clwn_1, "ADVIDEGEP", false},
				{StageId_Kapi_2, "   ART AND SPRITES", false},	
				{StageId_Clwn_1, "FIDY", false},
				{StageId_Clwn_1, "   CHARTING", false},
				{StageId_Clwn_1, "NIFFIRG", false},
				{StageId_Clwn_1, "   CHARTING", false},
				{StageId_Clwn_1, "DEE DAE", false},
				{StageId_Clwn_1, "   COMPOSER", false},
				{StageId_Clwn_1, "COTILES", false},
				{StageId_Clwn_1, "   COMPOSER", false},
				{StageId_Clwn_1, "TOTALLY NOT GENJI", false},
				{StageId_Clwn_1, "   COMPOSER", false},
				{StageId_Clwn_1, "VOIDICUS", false},
				{StageId_Clwn_1, "   COMPOSER", false},
				{StageId_Clwn_1, "BEBESITA", false},
				{StageId_Clwn_1, "   ART AND SPRITES", false},
				{StageId_Clwn_1, "XOOPLORD", false},
				{StageId_Clwn_1, "   LOADING MENUS", false},
				{StageId_Clwn_1, "OOLEXX", false},
				{StageId_Clwn_1, "   CODING", false},
				{StageId_Clwn_1, "JACK DOT EXE", false},
				{StageId_Clwn_1, "   CODING", false},
				{StageId_Clwn_1, "BITTECH", false},
				{StageId_Clwn_1, "   CODING", false},
				{StageId_Clwn_1, "ARTEMIY KOPYCH", false},
				{StageId_Clwn_1, "   EASTER EGGS", false},
				{StageId_Clwn_1, "BAMDAD", false},
				{StageId_Clwn_1, "   MECHANIC IDEAS", false},
				{StageId_Clwn_1, "SCORCHVX", false},
				{StageId_Clwn_1, "   VOICE ACTING", false},
				{StageId_Clwn_1, "BANBUDS", false},
				{StageId_Clwn_1, "   VOICE ACTING", false},
				{StageId_Clwn_1, "COUGAR MACDOWALL", false},
				{StageId_Clwn_1, "   VOICE ACTING", false},
				{StageId_Clwn_1, "MYSTMANTWELVE", false},
				{StageId_Clwn_1, "   BALDIS BASICS ORGINAL DEV", false},
